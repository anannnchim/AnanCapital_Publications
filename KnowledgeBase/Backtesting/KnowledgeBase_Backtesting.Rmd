...
1.  Create systematic way of testing.
...
5.  Understand it: get characteristic and performance. (e.g. return, behavior)

    [Single level vs Portfolio Level vs Universe level]{.underline}

    -   Behavior, Sharp ratio, edges, correlation, speed

6.  Test it: check the performance and compare to naive

    -   Benchmark: B&H and random.

7.  Break it: try to fail. (check robustness)
